...
void output_officer(int officerindex);       //DANNA.

//privileges of the admin.
void addcrime();                             //NOUR.
void addofficer();                           //NOUR. 
void updatecrime();                          //MENNA.
void search();                               //NOUR.
void displayall();                           //NOUR.
void classification_crimes_type();           //YOUSSEF.
void deletecrime();                          //NOURAN.
void officer_employment();                   //YOUSSEF.
...
void assigncrime_officer();                  //NOURAN.
...
void output_admin()
{
	...
	do
	{
		...
		cout << "  [5].CLASSIFICATION OF CRIMES WITH THEIR STATUS" << endl << endl;
...
void classification_crimes_type()
{
	...
	do
	{
		...
		case 3:
		{
			...
			if (found)
			{
				...
				cout << "  please enter the number you want to modify:"; cin >> option;
				while (option != 1 && option != 2 && option != 3)
				{
					cout << "  Invalid option...Please choose from menu..."; cin >> option;
					break;
